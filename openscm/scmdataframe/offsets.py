...
from pandas.tseries.offsets import as_datetime, NaT, conversion, normalize_date, BusinessMixin
...
def generate_range(start: datetime, end: datetime, offset):
    ...
    while current <= end:
        ...
        if next_current <= current:
            raise ValueError('Offset is not increasing datetime: {}'.format(current.isotime()))
