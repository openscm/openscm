...
\begin{tikzpicture}
  ...
  \begin{scope}
    ...
    minimum width=\componentwidth,
    minimum height=100pt,
    above right=\distancey and 0pt of core.north west,
    ] (pythonic) {};
    ...
    anchor=north,
    minimum width=\componentwidth,
    ] at (pythonic.north) {\texttt{openscm.openscm}};
    ...
    minimum width=\componentwidth,
      ...
      \begin{minipage}{0.9\componentwidth}
        \centering
        Provides pythonic convenience functions for single model runs
        including I/O and easy setting of parameters.
      \end{minipage}
    };
  \end{scope}
  \node[outline,fit=(pythonic)] {};
  \draw[connect] let \p1=(core.north), \p2=(pythonic.south) in (\x2,\y1) -- (\x2,\y2);
  ...
  \begin{scope}
    ...
    minimum width=\componentwidth,
    minimum height=50pt,
    above right=\distancey and 0pt of pythonic.north west,
    ] (users) {};
  ...
  \draw[connect] let \p1=(users.south), \p2=(core.north), \p3=(modeldots.north) in (\x3,\y1) -- (\x3,\y2);
  \draw[connect] let \p1=(users.south), \p2=(pythonic.north) in (\x2,\y1) -- (\x2,\y2);
